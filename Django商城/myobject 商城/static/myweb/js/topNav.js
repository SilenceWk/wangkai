 ...
 // }
  ...
  function topfz(){
    // for (var i = 0; i < 5; i++) {
      $('.layout-header-nav-item').eq(2).mouseover(function(){
        $('.wk_sm').show(800)
      });
      $('.layout-header-nav-item').eq(1).mouseover(function(){
        $('.wk_fz').show(800)
      });
      $('.layout-header-nav-item').eq(4).mouseover(function(){
        $('.wk_dy').show(800)
      });
      $('.layout-header-nav-item').eq(2).mouseout(function(){
        $('.wk_sm').hide(500)
      });
      $('.layout-header-nav-item').eq(1).mouseout(function(){
        $('.wk_fz').hide(500)
      });
      $('.layout-header-nav-item').eq(4).mouseout(function(){
        $('.wk_dy').hide(500)
      });
    // };
  }
